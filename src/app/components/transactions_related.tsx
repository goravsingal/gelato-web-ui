...
function TransactionsRelated({
  transactions,
  fetchRelatedTxsAsync
}: {
  transactions: Transaction[];
  fetchRelatedTxsAsync: () => Promise<void>;
}) {
  return (
    <>
          <h5 className="mt-4">Current Transactions</h5>
          <Button onClick={fetchRelatedTxsAsync} variant="secondary">Refresh Transactions</Button>
...
export default TransactionsRelated;